...
export default function BookItem(book) {
  const [isFavorite, setIsFavorite] = useState(book.book.favorite);
    ...
    <>
      <div className="space-y-3">
        <div
         ...
         border-[#324251]/30 bg-white p-4"
        >
          <img
            className="max-w-[144px] h-[180px]"
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <h4 className="text-lg font-bold lg:text-xl">${book.book.price}</h4>
          ...
          <div className="flex items-center gap-3 text-xs lg:text-sm">
            <button
             ...
             gap-1 rounded-md bg-[#1C4336] py-1.5 text-white transition-all hover:opacity-80 lg:py-1.5"
            >
              <svg
